...
class PromotionalProductController extends Controller
{
    ...
    public function promoProductList(Request $request)
    {
        ...
        foreach ($records as $record) {
            ...
            $edit_button = '';
            $delete_button = '';
            if(auth()->user()->can('edit-promotional-products') || auth()->user()->hasRole('super-admin'))
                $edit_button = '<li>
            ...
            if(auth()->user()->can('delete-promotional-products') || auth()->user()->hasRole('super-admin'))
                $delete_button =    '<li>
                                        <form user="deleteForm" method="POST" action="' . $delete_route . '">
